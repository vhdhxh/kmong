    ...
    <a id="room${chat.roomId}" href="/chat/${chat.roomId}/${chat.otherNickname}">
        <div class="chat_list ${active}">
            <div class="chat_people">
                <div class="chat_img"> <img src="https://ptetutorials.com/images/user-profile.png" onerror="this.onerror=null; this.src='https://ptetutorials.com/images/user-profile.png';"> </div>
                <div class="chat_ib">
